...
export const PriceFilter = ({ filters, setFilters }) => {
    ...
    return (
        <Collapsible title="Price range" initialOpen={true}>
            ...
            {/* Inputs */}
            <div className="flex gap-[1.1rem] mb-3.5">
                <label htmlFor="min-input" className="flex-1">
                    <span className="text-[#1C1C1C] ml-0.5">Min</span>
                    <input
                        type="number"
                        id="min-input"
                        ...
                        step={STEP}
                        placeholder="Min"
                        className="w-full h-10 text-[#1C1C1C] bg-white px-2.5 mt-0.5 border border-[#DEE2E7] rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400"
                        value={tempMin}
                        onChange={(e) => handleInputChange(e, "min")}
                    />
                </label>
                <label htmlFor="max-input" className="flex-1">
                    <span className="text-[#1C1C1C] ml-0.5">Max</span>
                    <input
                        type="number"
                        id="max-input"
            ...
            <button
                onClick={handleApply}
                className="w-full h-10 text-[#0D6EFD] font-medium bg-white hover:bg-gray-50/95 border border-[#DEE2E7] rounded-md shadow-sm transitions"
            >
                Apply
            </button>
        </Collapsible>
